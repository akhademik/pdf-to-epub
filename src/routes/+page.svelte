...
<div class="m-8 font-sans">
	<h1 class="mb-4 text-2xl font-bold">PDF to EPUB Converter</h1>

	<div class="mb-4">
		<label for="pdf-upload" class="mb-2 block">Upload PDF:</label>
		<input
			id="pdf-upload"
			type="file"
	...
	<div class="mb-4">
		<label for="toc" class="mb-2 block">Table of Contents:</label>
		<textarea
			id="toc"
			bind:value={toc}
			rows="10"
			class="w-full border p-2"
			placeholder="Chapter 1: 1-20&#10;Chapter 2: 21-45"
		></textarea>
	</div>

	<div class="mb-4">
		<label for="page-correction" class="mb-2 block">Page Correction:</label>
		<input
			id="page-correction"
			type="text"
			bind:value={pageCorrection}
			class="border p-2"
	...
	<button
		...
		disabled={!pdfFile}
		class="cursor-pointer rounded-md bg-blue-500 px-4 py-2 text-white disabled:cursor-not-allowed disabled:bg-gray-400"
	>
		Convert to EPUB
	</button>
